...
function DirectionsScreen() {
  ...
  const handlePress = () => {
    ...
    setTimeout(() => {
      setDirections('Go five steps to the right, then turn left, and go straight till you reach a door');
    }, 5000);
  };
  ...
  return (
    <View style={styles.container}>
      ...
      {directions ? <Text style={styles.directionsText}>{directions}</Text> : null}
    </View>
  );
}
